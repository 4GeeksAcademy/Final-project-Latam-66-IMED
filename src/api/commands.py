    ...
    def insert_test_data():
        ...
        restaurantes_semilla = [
            {"name": "La Hacienda", "score": 92, "food_type": "Cortes", "cuisine_origin": "Argentina", "city": "Caracas",
                "image_url": "https://placehold.co/600x400?text=Parrilla", "description": "Las mejores brasas de Caracas."},
            {"name": "Sake House", "score": 85, "food_type": "Sushi", "cuisine_origin": "Japonesa", "city": "Caracas",
                "image_url": "https://placehold.co/600x400?text=Sushi", "description": "Fusión tradicional y moderna."},
            {"name": "El Ávila Burger", "score": 78, "food_type": "Hamburguesas", "cuisine_origin": "Americana", "city": "Caracas",
                "image_url": "https://placehold.co/600x400?text=Burger", "description": "Sabor urbano con vista al Ávila."},
            {"name": "Trattoria Mia", "score": 88, "food_type": "Pasta", "cuisine_origin": "Italiana", "city": "Caracas",
                "image_url": "https://placehold.co/600x400?text=Pasta", "description": "Recetas de la abuela directo de Roma."},
            {"name": "Arepa Factory", "score": 95, "food_type": "Rellena", "cuisine_origin": "Venezolana", "city": "Caracas",
                "image_url": "https://placehold.co/600x400?text=Arepa", "description": "Nuestra esencia en cada bocado."},
            {"name": "Taco Real", "score": 55, "food_type": "Tacos", "cuisine_origin": "Mexicana", "city": "CDMX",
                "image_url": "https://placehold.co/600x400?text=Tacos", "description": "Picante auténtico de CDMX."},
            {"name": "Chifa Express", "score": 62, "food_type": "Arroz", "cuisine_origin": "China", "city": "Lima",
                "image_url": "https://placehold.co/600x400?text=Chifa", "description": "El mejor wok del centro."},
            {"name": "Paella & Olé", "score": 81, "food_type": "Arroz", "cuisine_origin": "Española", "city": "Madrid",
                "image_url": "https://placehold.co/600x400?text=Paella", "description": "Sabor a mar y azafrán."},
            {"name": "Bangkok Soul", "score": 45, "food_type": "Pad Thai", "cuisine_origin": "Tailandesa", "city": "Bangkok",
                "image_url": "https://placehold.co/600x400?text=Thai", "description": "Especias exóticas y frescura."},
            {"name": "Lima 27", "score": 90, "food_type": "Ceviche", "cuisine_origin": "Peruana", "city": "Lima",
                "image_url": "https://placehold.co/600x400?text=Ceviche", "description": "Alta cocina andina."}
        ]
