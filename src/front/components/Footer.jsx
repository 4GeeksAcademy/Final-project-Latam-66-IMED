...
export const Footer = () => {
  return (
    <footer className="bg-fc-dark text-fc-light py-5 mt-5 border-top border-fc-red">
      <div className="container">
        <div className="row gy-4">

          {/* COLUMNA 1: LOGO Y DESCRIPCIÓN */}
          <div className="col-12 col-md-4">
            <Link to="/" className="text-decoration-none fs-3 fw-bold mb-3 d-inline-block">
            ...
            <p className="text-secondary" style={{ maxWidth: "300px" }}>
              La plataforma definitiva para amantes de la gastronomía. Comparte, descubre y critica los mejores sabores del mundo.
            </p>
          </div>
        ...
        {/* COPYRIGHT */}
        <div className="row mt-5 pt-4 border-top border-secondary text-center text-secondary">
          <div className="col">
            <small>&copy; {new Date().getFullYear()} FlavorCritic. Todos los derechos reservados.</small>
          </div>
        </div>
      </div>
    </footer>
